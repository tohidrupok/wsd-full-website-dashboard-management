...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('civil', '0002_civil_payment_civil_mobilepayment_civil_bankpayment'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='civil_payment',
            name='order',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='civil_order_payment', to='civil.civil_order'),
        ),
        migrations.AlterField(
            model_name='civil_payment',
            name='payment_method',
            field=models.CharField(blank=True, choices=[('bank', 'Bank'), ('mobile', 'Mobile')], max_length=10, null=True),
        ),
        migrations.AlterField(
            model_name='civil_payment',
            name='payment_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='civil.civil_payment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refund', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='civil.civil_refund')),
            ],
        ),
        migrations.CreateModel(
